...
def calculateMetric(result):
    ...
    if(isMultiClass):
        ...
        f1 = skmetr.f1_score(labels, predictions)
    ...
    return {"accuracy" : accuracy, "precision" : precision, "recall" : recall, "roc" : roc, 'f1': f1}
    ...
    for results in resultss:
        ...
        for result in results:
            ...
            if(isMultiClass):
                ...
                train_f1 = skmetr.f1_score(train_labels, train_predictions)
                test_f1 = skmetr.f1_score(test_labels, test_predictions)
            ...
            metric = {"train" : {"accuracy" : train_accuracy, "precision" : train_precision, "recall" : train_recall , "roc" : train_roc, 'f1': train_f1},
                "test" : {"accuracy" : test_accuracy, "precision" : test_precision, "recall" : test_recall, "roc" : test_roc, 'f1': test_f1}}
